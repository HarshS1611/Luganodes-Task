...
const Navbar = () => {
    ...
    return (
        <>
            <nav class="flex w-full justify-between shadow-md border-b-[1px] border-black bg-[#03203F] items-center flex-wrap py-4 px-10 lg:px-20 xl:px-60">
                <div className='flex'>
                    ...
                    <div class="w-max flex ml-5 md:flex-0 items-center justify-start lg:w-fit">
                        <div class="text-md gap-4 md:flex">
                            <div class="flex mt-2 font-lab-grotesque cursor-pointer gap-1 items-center lg:mt-2 text-gray-500 mr-4 pb-2 "

                            >
                                Ronin Price : <p className='text-sky-700'> ${price && (price+0.265).toLocaleString().substring(0, 4)} </p>
                            </div>
                            <div class="flex block mt-2 font-lab-grotesque cursor-pointer gap-1 items-center lg:mt-2 text-gray-500 mr-4 pb-2"

    ...
    return (
        <>
            <nav class="flex w-full justify-between shadow-md border-b-[1px] border-black bg-[#03203F] items-center flex-wrap md:py-4 px-4 md:px-10 lg:px-20 xl:px-60">
                ...
                <div className='hidden relative flex right-0 justify-end'>
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="flex items-center px-4 py-2 text-white bg-gray-800 rounded-md text-md" type="button" onClick={() => setIsDropdownOpen(!isDropdownOpen)}> Mainnet <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
                    </svg>
                    </button>

                    {/* Toggle class based on state */}
                    <div id="dropdown" className={` absolute z-10 top-14 ${isDropdownOpen ? '' : 'hidden'} bg-gray-800 divide-y divide-gray-100 rounded-lg shadow-md w-full`}>
                        <ul class="my-2 mx-4 text-sm " aria-labelledby="dropdownDefaultButton">
                            <li>
                                <a href="#" class="block w-full text-md text-white mb-1 mt-2 px-4 py-1 rounded hover:bg-gray-500 text-sm">Mainnet</a>
                            </li>
                            <li><hr /></li>
                            <li>
                                <a href="#" class="block text-md text-white rounded mb-2 mt-1 px-4 py-1  hover:bg-gray-500 text-sm">Testnet</a>
                            </li>
